...
const RICH: sanitizeHtml.IOptions = {
  ...
  // data-bid: stable block ids that page handwriting is anchored to.
  allowedAttributes: {
    div: ["data-type", "data-id", "data-strokes", "data-height", "data-paper", "data-bid", "class"],
    ...
    span: ["style"],
    p: ["style", "data-bid"],
    h1: ["style", "data-bid"], h2: ["style", "data-bid"], h3: ["style", "data-bid"], h4: ["style", "data-bid"],
    ul: ["data-type", "data-bid"],
    ol: ["start", "type", "data-bid"],
    li: ["data-type", "data-checked", "data-bid"],
    input: ["type", "checked"],
    th: ["colspan", "rowspan", "colwidth"],
    td: ["colspan", "rowspan", "colwidth"],
    col: ["style"],
    table: ["style", "data-bid"],
    blockquote: ["data-bid"],
    pre: ["data-bid"],
    hr: ["data-bid"],
  },
